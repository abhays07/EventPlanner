...
export const UpdateContacts = async (req, res, next) => {
  try {
    ...
    <div style="max-width: 600px; background-color: #ffffff; margin: 0 auto; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); padding: 30px;">
      <h2 style="color: #333333;">Message from AS Events</h2>

      <p style="margin: 10px 0;"><strong style="color: #555;">To :</strong> <span style="color: #000;">${
        updatedQuery.name
      }</span></p>
      ...
      <p style="margin: 10px 0;"><strong style="color: #555;">Your Query :</strong><br />
        <span style="color: #000;">${updatedQuery.message}</span>
      </p>

      <p style="margin: 10px 0;"><strong style="color: #555;">Reply :</strong><br />
      ...
      <p style="margin-top: 30px; font-size: 12px; color: #999; text-align: center;">
        © ${new Date().getFullYear()} AS Events Planner PVT. LTD. | All rights reserved.
      </p>
    </div>
  </div>
    `;
